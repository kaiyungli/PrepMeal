      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        {onFavorite && (
          <button 
            ...
            className={`absolute top-3 right-3 rounded-full w-9 h-9 flex items-center justify-center shadow-lg backdrop-blur-sm border border-white/20 z-10 transition-all duration-200 hover:scale-110 ${
              isFavorite 
