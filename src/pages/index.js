...
// Sample menu (static for fast load)
const sampleMenu = [
  { day: '星期一', name: '番茄炒蛋', cooking_time: 15 },
  { day: '星期二', name: '麻婆豆腐', cooking_time: 25 },
  { day: '星期三', name: '蔥花蒸水蛋', cooking_time: 20 },
  { day: '星期四', name: '番茄炒蛋', cooking_time: 15 },
  { day: '星期五', name: '麻婆豆腐', cooking_time: 25 },
  { day: '星期六', name: '蔥花蒸水蛋', cooking_time: 20 },
  { day: '星期日', name: '番茄炒蛋', cooking_time: 15 },
];
